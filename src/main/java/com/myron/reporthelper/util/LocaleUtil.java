...
import com.myron.reporthelper.spring.converter.CustomResourceBundleMessageSource;
...
public class LocaleUtil {
    ...
    @Autowired
    public LocaleUtil(final LocaleResolver localeResolver, final MessageSource messageSource) {
