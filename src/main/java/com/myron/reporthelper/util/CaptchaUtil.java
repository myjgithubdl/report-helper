...
public class CaptchaUtil {
	private static final String CAPTCHA_ATTR = CaptchaUtil.class.getName().concat(".CAPTCHA");
	 ...
	 * @param isRemoveCaptcha 是否删除验证码
	 * @return 验证通过返回 true, 否则返回 false
	 */
	public static boolean validate(HttpServletRequest request, String userInputCaptcha , boolean isRemoveCaptcha) {
		...
		log.info("用户输入验证码："+userInputCaptcha+"		系统存储验证码："+code);
		boolean result = userInputCaptcha.equals(code);
		if (result && isRemoveCaptcha) {
