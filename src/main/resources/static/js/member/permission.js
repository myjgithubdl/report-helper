...
var PermCommon = {
    baseUrl: ReportHelper.ctxPath + '/rest/member/permission/',
    baseMenuUrl: ReportHelper.ctxPath + '/rest/member/menu/',
    baseIconUrl: ReportHelper.ctxPath + '/custom/easyui/themes/icons/'
};
    ...
    View: {
        initControl: function () {
            ...
            $('#module-tree').tree({
                checkbox: false,
                method: 'get',
                url: PermMVC.URLs.getChildMenus.url,
                onClick: function (node) {
                    $('#module-tree').tree('expand', node.target);
                    $('#module-tree').tree('options').url = PermMVC.URLs.getChildMenus.url;
