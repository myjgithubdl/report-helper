...
var HomeIndexMVC = {
    URLs: {
        getMenus: {
            url: ReportHelper.ctxPath + '/rest/home/getMenus',
            method: 'GET'
        },
        changeMyPassword: {
            url: ReportHelper.ctxPath + '/rest/member/user/changeMyPassword',
            method: 'POST'
        },
        designer: {
            url: ReportHelper.ctxPath + '/views/report/designer',
            method: 'GET'
        },
        logout: {
            url: ReportHelper.ctxPath + '/member/logout',
            method: 'POST'
        }
    },
    View: {
        ...
        buildMenu: function (loginUser) {
            $.getJSON(HomeIndexMVC.URLs.getMenus.url, function (result) {
                ...
                for (var i = 0; i < roots.length; i++) {
                    ...
                    var url = module.linkType ? module.url : ReportHelper.ctxPath + '/' + module.url;
